        ...
        <div class="relative">
          ...
          >
            <swiper-slide v-for="tech in technologies" :key="tech.name">
              ...
              >
                <!-- Use Iconify for brand logos -->
                <Icon
                  :icon="tech.icon"
                  :class="`w-10 h-10 text-gray-400 group-hover:text-${tech.color}-400 transition-colors`"
                />
              </div>
            </swiper-slide>
          </swiper>
...
// HeroIcons hanya untuk UI icons (bukan brand logos)
